<?php
/*/*
 Template Name: Проекты 2-я страницы
  */
//
//get_header(); */?>
<!DOCTYPE html>
...
375 0 375 -170 0 -170 0 0 -910z"/>
    ...
    <div class="bckg-wrp">
        ...
        <img src="/images/Light/main-img.jpg" data-bg="1" alt="" class="bckg hide">
        <img src="/images/gorkogo/main-img.jpg" data-bg="2" alt="" class="bckg hide">
        <img src="/images/Zhulyany/main-img.jpg" data-bg="3" alt="" class="bckg hide">
        <img src="/images/tihayagovoni/main-img.jpg" data-bg="4" alt="" class="bckg hide">
        <img src="/images/odessa/main-img.jpg" data-bg="5" alt="" class="bckg hide">
        <img src="/images/eskada/main-img.jpg" data-bg="6" alt="" class="bckg hide">
        <img src="/images/Concept/main-img.jpg" data-bg="7" alt="" class="bckg hide">
        <img src="/images/Rayon/main-img.jpg" data-bg="8" alt="" class="bckg hide">
        <img src="/wp-content/uploads/2018/02/top_1.jpg" data-bg="9" alt="Визуализация проекта" class="bckg hide">
        <img src="/wp-content/uploads/2018/02/korch-00.jpg" data-bg="10" alt="" class="bckg hide">
        <img src="/images/zamkoveckiy/main-img.jpg" data-bg="11" alt="Визуализация проекта" class="bckg hide">
        <img src="/wp-content/uploads/2018/06/Montazhnaya-oblast-1-kopiya-9.png" data-bg="12" alt="Визуализация проекта" class="bckg hide">
        <img src="/wp-content/uploads/2018/06/Montazhnaya-oblast-1-kopiya-3.png" data-bg="13" alt="Визуализация проекта" class="bckg hide">
        <img src="/wp-content/uploads/2018/06/Montazhnaya-oblast-1-kopiya-11.png" data-bg="14" alt="" class="bckg hide">
        <img src="/wp-content/uploads/2018/11/Tem_v2-b.jpg" data-bg="15" alt="" class="bckg hide">
        <img src="/wp-content/uploads/2018/11/Chapa_1white-1.jpg" data-bg="16" alt="" class="bckg hide">
        <img src="/wp-content/uploads/2018/11/zolotii-bereg.jpg" data-bg="17" alt="" class="bckg hide">
...
<a href="https://davinchi.com.ua/?page_id=1133&preview=true" class="cell" data-id="15" data-proj="/wp-content/uploads/2018/11/Tem_v2-b.jpg">
    <div class="logo-table">
        <div class="text-cell">
            <p class="name">Concept Cube</p>
            <p class="city">г.Киев</p>
        </div>
    </div>
</a>
<a href="https://davinchi.com.ua/?page_id=1122&preview=true" class="cell" data-id="16" data-proj="/wp-content/uploads/2018/11/Chapa_1white-1.jpg">
    <div class="logo-table">
        <div class="text-cell">
            <p class="name">Concept Private House</p>
            <p class="city">г.Киев</p>
        </div>
    </div>
</a>
<a href="https://davinchi.com.ua/?page_id=1123&preview=true" class="cell" data-id="17" data-proj="/wp-content/uploads/2018/11/zolotii-bereg.jpg">
    <div class="logo-table">
        <div class="text-cell">
            <p class="name">Concept Z</p>
            <p class="city">г.Киев</p>
        </div>
    </div>
</a>
    ...
    <div class="projects">
        <div class="content-table">
            ...
            <div class="row">
                ...
                <a href="/da-vinchi-group-il-patio.html" class="cell" data-id="14" data-proj="/images/Light/main-img.jpg">
                    <div class="logo-table">
                        <div class="text-cell">
                            <p class="name">Il Patio</p>
                            <p class="city">г.Киев</p>
                        </div>
                    </div>
                </a>
                ...
                <a href="/concept-g.html" class="cell cell_concept" data-id="2" data-proj="/images/gorkogo/main-img.jpg">
                    <div class="logo-table">
                        <div class="text-cell">
                            <p class="name">Concept G</p>
                            <p class="city">г.Киев</p>
                        </div>
                    </div>
                </a>
            ...
            <div class="row">
                ...
                <a href="/tihaya-gavan.html" class="cell" data-id="4" data-proj="/wp-content/uploads/2018/02/top-min.jpg">
                    <div class="logo-table">
                        <div class="text-cell">
                            <p class="name">Тихая Гавань</p>
                            <p class="city">г.Киев</p>
                        </div>
                    </div>
                </a>
            ...
            <div class="row">
                ...
                <a href="/concept-f.html" class="cell" data-id="7" data-proj="/images/Concept/main-img.jpg">
                    <div class="logo-table">
                        <div class="text-cell">
                            <p class="name">Concept F</p>
                            <p class="city">г.Одесса</p>
                        </div>
                    </div>
                </a>

                <a href="/rayon-house.html" class="cell" data-id="8" data-proj="/images/Rayon/main-img.jpg">
                    <div class="logo-table">
                        <div class="text-cell">
                            <p class="name">Район</p>
                            <p class="city">г.Киев</p>
                        </div>
                    </div>
                </a>

                <a href="/concept-t.html" class="cell" data-id="9" data-proj="/wp-content/uploads/2018/02/top_1.jpg">
                    <div class="logo-table">
                        <div class="text-cell">
                            <p class="name">Concept T</p>
                            <p class="city">г.Киев</p>
                        </div>
                    </div>
                </a>
                ...
                <a href="/da-vinchi-group-office-center-t.html" class="cell" data-id="13" data-proj="/wp-content/uploads/2018/02/korch-00.jpg">
                    <div class="logo-table">
                        <div class="text-cell">
                            <p class="name">Office Center T</p>
                            <p class="city">г.Киев</p>
                        </div>
                    </div>
                </a>
            ...
            <div class="row">
                ...
                <a href="/projects.html" class="cell prev">
                    <div class="content-wrapper">
                        <div class="button-wrapper button-wrapper-prev">
                        ...
                        <div class="text-wrapper">
                            <p class="first-line">Предыдущие</p>
                ...
                <a href="/da-vinci-club-house.html" class="cell" data-id="11" data-proj="/images/zamkoveckiy/main-img.jpg">
                    <div class="logo-table">
                        <div class="text-cell">
                            <p class="name">Da Vinchi Club House</p>
                            <p class="city">г.Киев</p>
                        </div>
                    </div>
                </a>

                <a href="da-vinchi-group-sommercial-office-center-l.html" class="cell" data-id="12" data-proj="/wp-content/uploads/2018/06/Montazhnaya-oblast-1-kopiya-9.png">
                    <div class="logo-table">
                        <div class="text-cell">
                            <p class="name">Сommercial Office Center L</p>
                            <p class="city">г.Львов</p>
                        </div>
                    </div>
                </a>

                <a href="/da-vinchi-group-proekty-3.html" class="cell next">
                    <div class="content-wrapper">
                        <div class="text-wrapper">
