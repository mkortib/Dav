<?php
/*
 Template Name: Проекты 3-я страницы
  */
?>
<!DOCTYPE html>
...
375 0 375 -170 0 -170 0 0 -910z"/>
    ...
    <div class="bckg-wrp">
        ...
        <img src="/wp-content/uploads/2018/06/Montazhnaya-oblast-1-kopiya-11.png" data-bg="1" alt="" class="bckg hide">
        <img src="/wp-content/uploads/2018/10/Z-_DLYA-MARKETOLOGA_YAroslaviv-Val_1920_Val6.jpg" data-bg="2" alt="" class="bckg hide">
        <img src="/wp-content/uploads/2018/10/Rajon_7k_night1vika.jpg" data-bg="18" alt="" class="bckg hide">
        <img src="/wp-content/uploads/2018/04/1080-praga-2-TOP.jpg" data-bg="4" alt="" class="bckg hide">
        <img src="/wp-content/uploads/2018/11/Tem_v2-b.jpg" data-bg="5" alt="" class="bckg hide">
        <img src="/wp-content/uploads/2018/11/Chapa_1white-1.jpg" data-bg="6" alt="" class="bckg hide">
        <img src="/wp-content/uploads/2018/11/Ural_air.jpg" data-bg="7" alt="" class="bckg hide">
        <img src="/wp-content/uploads/2018/11/zolotii-bereg.jpg" data-bg="8" alt="" class="bckg hide">
        <img src="/wp-content/uploads/2018/04/1080-praga-2-TOP.jpg" data-bg="9" alt="" class="bckg hide">
        ...
        <img src="/images/Light/main-img.jpg" data-bg="13" alt="" class="bckg hide">
        <img src="/images/Zhulyany/main-img.jpg" data-bg="14" alt="" class="bckg hide">
        <img src="/images/odessa/main-img.jpg" data-bg="15" alt="" class="bckg hide">
        <img src="/images/eskada/main-img.jpg" data-bg="16" alt="" class="bckg hide">
        <img src="/wp-content/uploads/2018/04/1080-praga-2-TOP.jpg" data-bg="17" alt="" class="bckg hide">
        <img src="/wp-content/uploads/2018/02/korch-00.jpg" data-bg="18" alt="" class="bckg hide">
        <img src="/wp-content/uploads/2019/03/Milya_street_night-1.jpg" data-bg="19" alt="" class="bckg hide">
    </div>
    <!-- Backgrounds END -->
    ...
    <div class="projects">
        <div class="content-table">
            ...
            <div class="row">
                ...
                <a href="/light-house.html" class="cell" data-id="13" data-proj="/images/Light/main-img.jpg">
                    <div class="logo-table">
                        <div class="text-cell">
                            <p class="name">Light House</p>
                ...
                <a href="/da-vinchi-group-office-center-p.html" class="cell" data-id="12" data-proj="/wp-content/uploads/2018/06/Montazhnaya-oblast-1-kopiya-3-1.png">
                    <div class="logo-table">
                        <div class="text-cell">
                            <p class="name">Office Center P</p>
                            <p class="city">г.Киев</p>
                        </div>
                    </div>
                </a>
            ...
            <div class="row">
                ...
                <a href="/da-vinchi-group-rayon-2.html" class="cell" data-id="18" data-proj="/wp-content/uploads/2018/10/Rajon_7k_night1vika.jpg">
                    <div class="logo-table">
                        <div class="text-cell">
                            <p class="name">Rayon 2</p>
                            <p class="city">г.Киев</p>
                        </div>
                    </div>
                </a>

                <a href="/proekt-zhulyani.html" class="cell" data-id="14" data-proj="/images/Zhulyany/main-img.jpg">
                    <div class="logo-table">
                        <div class="text-cell">
                            <p class="name">Жуляны</p>
                            <p class="city">г.Киев</p>
                        </div>
                    </div>
                </a>
                <a href="/odessa-house.html" class="cell" data-id="15" data-proj="/images/odessa/main-img.jpg">
                <div class="logo-table">
                    <div class="text-cell">
                        <p class="name">Набережный квартал</p>
                        <p class="city">г.Одесса</p>
                    </div>
                </div>
                </a>
                <a href="/eskada.html" class="cell" data-id="16" data-proj="/images/eskada/main-img.jpg">
                    <div class="logo-table">
                        <div class="text-cell">
                            <p class="name">Эскада</p>
                            <p class="city">г.Киев</p>
                        </div>
                    </div>
                </a>
            ...
            <div class="row">
                ...
                <a href="https://davinchi.com.ua/?page_id=1193&preview=true" class="cell" data-id="7" data-proj="/wp-content/uploads/2018/11/Ural_air.jpg">
                    <div class="logo-table">
                        <div class="text-cell">
                            <p class="name">Concept U</p>
                            <p class="city">г.Киев</p>
                        </div>
                    </div>
                </a>

                <a href="/campus.html" class="cell" data-id="3" data-proj="/wp-content/uploads/2018/02/top-min.jpg">
                    <div class="logo-table">
                        <div class="text-cell">
                            <p class="name">Campus</p>
                            <p class="city">г.Киев</p>
                        </div>
                    </div>
                </a>

                <a href="/da-vinchi-group-concept-kvartal-l.html" class="cell" data-id="17" data-proj="/wp-content/uploads/2018/04/1080-praga-2-TOP.jpg">
                    <div class="logo-table">
                        <div class="text-cell">
                            <p class="name">Concept Kvartal L</p>
                            <p class="city">г.Киев</p>
                        </div>
                    </div>
                </a>

                <a href="/concept-k.html" class="cell" data-id="18" data-proj="/wp-content/uploads/2018/02/korch-00.jpg">
                    <div class="logo-table">
                        <div class="text-cell">
                            <p class="name">Concept K</p>
                            <p class="city">г.Киев</p>
                        </div>
                    </div>
                </a>
            ...
            <div class="row">
                ...
                <a href="/proekty-2.html" class="cell prev">
                ...
                <a href="/da-vinchi-group-concept-kvartal-m.html" class="cell" data-id="19" data-proj="/wp-content/uploads/2019/03/Milya_street_night-1.jpg">
                    <div class="logo-table">
                        <div class="text-cell">
                            <p class="name">Concept Kvartal M</p>
                            <p class="city">г.Киев</p>
                        </div>
                    </div>
                </a>
                ...
                <a href="/projects.html" class="cell next">
                    <div class="content-wrapper">
                        <div class="text-wrapper">
                        ...
                        <div class="button-wrapper">
                            <svg id="Capa_1" data-name="Capa 1" width="37px" height="37px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64">
                                <defs>
                                    <style>.cls-1{fill:#414141;}</style>
                                </defs>
